      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="grid gap-6 sm:grid-cols-2 mb-8">
          ...
          >
            ...
            <h3 className="mb-2 text-lg font-bold text-white relative z-10">Generative AI Green Report</h3>
            ...
            <button
              onClick={() => alert(`AI Analysis for ${impactStats.totalCo2Saved}g CO2 saved:\n\n"You are showing excellent promise! Your choices indicate a strong preference for sustainable transport. By opting for the metro instead of cabs, you've reduced your footprint significantly. Keep focusing on reducing your single-use plastics to reach the Forest tier faster!"`)}
              className="relative z-10 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-3 text-sm font-bold text-white shadow-lg hover:scale-105 transition"
            >
              Generate AI Report ✨
            </button>
          </motion.div>
